<html lang="en">
    ...
    <?php
		echo "<title>ASE 230 - Mohammed Alaryani</title>";
    ?>
		<div class="container text-center mb-5">
      <?php
			echo "<h1>This is ASE 230 - Mohammed Alaryani</h1>";
      ?>
		</div>
    ...
    <div class="row">
      <div class="col-lg-5 col-md-6">
        ...
        <div class="mb-2 d-flex">
          <?php
          echo "<h4 class=\"font-weight-normal\">Mohammed Alaryani</h4>";
          ?>
          <div class="social d-flex ml-auto">
            <?php
            echo "<p class=\"pr-2 font-weight-normal\">Follow on:</p>";
            ?>
        ...
        <div class="mb-2">
          <ul class="list-unstyled">
            ...
            <li class="media">
              ...
              echo "<label class=\"media-body\">support@technol.com</label>";
              ?>
            </li>
          </ul>
        </div>
      ...
      <div class="col-lg-7 col-md-6 pl-xl-3">
        ...
        echo "<p>Along with your plans, you should consider developing an action orientation that will keep you motivated to move forward at all times. This requires a little self-discipline, but is a crucial component to achievement of any kind. Before starting any new activity, ask yourself if that activity will move you closer to your goals. If the answer is no, you may want to reconsider doing it at that time.</p>";
        ?>
        ...
        <div class="py-1">
          <div class="progress">
            <div class="progress-bar" role="progressbar" style="width:85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
              <?php
              echo "<div class=\"progress-bar-title\">Java</div>";
        ...
        <div class="py-1">
          <div class="progress">
            <div class="progress-bar" role="progressbar" style="width:70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
              <?php
              echo "<div class=\"progress-bar-title\">Python</div>";
              echo "<span class=\"progress-bar-number\">85%</span>";
              ?>
            </div>
          </div>
        ...
        <div class="py-1">
          <div class="progress">
            <div class="progress-bar" role="progressbar" style="width:77%" aria-valuenow="77" aria-valuemin="0" aria-valuemax="100">
              <?php
              echo "<div class=\"progress-bar-title\">Javascript</div>";
              echo "<span class=\"progress-bar-number\">80%</span>";
              ?>
            </div>
          </div>
        </div>
